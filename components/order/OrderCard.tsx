import { completeOrder } from "@/actions/complete-orde-action"
    ...
    return (
        ...
        >
            ...
            <dl className="mt-6 space-y-4">
                {order.orderProducts.map(product => (
                    <div key={product.productId} className="flex items-center gap-2 border-t border-gray-200 pt-4">
                        ...
                        <dd className="text-sm font-medium text-gray-900">{product.product.extras.length > 0 ? (
            ...
            <form action={completeOrder}>
                <input type="hidden" value={order.idOrder} name="order_id" />
                <input
                    type="submit"
